...
# Definition layer (generate the sequence of VGG16 feature extraction layer) 
...
if __name__ == '__main__':
	...
	score, geo = m(x) 
	print(score.shape) #([1, 1, 64, 64])
	print(geo.shape) # ([1, 5, 64, 64])
