...
if __name__ == '__main__':
    ...
    #     elif dataset == 'bigvul/balanced':
    #         ds = '/data1/chaoni/kaiwen/full_experiment_real_data_processed/bigvul/balanced/'
    #     elif dataset == 'bigvul/imbalanced':
    #         ds = '/data1/chaoni/kaiwen/full_experiment_real_data_processed/bigvul/imbalanced/'
    #     else:
    ...
    ds = f'/data1/kaiwenyang/CLVD/storage/cache/ggnn_output/{args.dataset}/ggnn_output.bin'
    ...
    ggnn_output = torch.load(f'/data1/kaiwenyang/CLVD/storage/cache/ggnn_output/{args.dataset}/ggnn_output.bin')
    features = []
    targets = []
