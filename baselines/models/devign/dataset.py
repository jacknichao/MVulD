...
class BigVulDatasetDevign(BigVulDataset):
    ...
    def __getitem__(self, idx):
        """Override getitem."""
        _id = self.idx2id[idx] # using index to get id
        ...
        text_feats = self.w2v.get_embeddings_list(code) # d= 100
        # use one hot to represent node type
        structure_feats = [type_one_hot[type_map[node_type] - 1] for node_type in nt] # d=32
        node_feats = np.concatenate([structure_feats, text_feats], axis=1) # d=132
