...
def add_args(parser):
    parser.add_argument('--save_unixcoder_embedding', action='store_true')
    ...
    parser.add_argument("--tokenizer_name", default="microsoft/unixcoder-base-nine", type=str,
    ...
    parser.add_argument('--dataset', type=str, required=True) # 先注释掉
    parser.add_argument("--do_patch", action='store_true',)
    parser.add_argument("--not_balance", action='store_true',) # action='store_true' 和 default=False 效果是一样的
